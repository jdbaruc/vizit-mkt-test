...
const RetailerGlyph = ({ retailer }) => {
  const src = retailer === 'walmart'
    ? ((window.__resources && window.__resources.img_walmart) || 'assets/walmart.png')
    : ((window.__resources && window.__resources.img_amazon)  || 'assets/amazon.png');
